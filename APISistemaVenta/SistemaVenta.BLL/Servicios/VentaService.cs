    ...
    public class VentaService : IVentaService
    {
        ...
        public async Task<List<ReporteDTO>> Reporte(string fechaInicio, string fechaFin)
        {
            ...
            try
            {
                ...
                ListaResultado = await query.Include(p => p.IdProductoNavigation).Include(v => v.IdVentaNavigation).Where(dv => dv.IdVentaNavigation.FechaRegistro.Value.Date >= fech_Inicio.Date && dv.IdVentaNavigation.FechaRegistro.Value.Date <= fech_Fin).ToListAsync();
